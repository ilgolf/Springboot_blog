...
public class UserController {
    ...
    public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
        ...
        params.add("client_id", "66e9cc86ff0f7c677b3cdc3db944c605");
        ...
        System.out.println("카카오 엑세스 토큰 : "+oauthToken.getAccess_token()); // 찍혀요 여기까진
       ...
       // System.out.println(response2.getBody());  // 여기도 찍혀요
        ...
        User originUser = userService.find_user(kakaoUser.getUsername());

        if(originUser.getUsername() == null) {
            System.out.println("회원이 아니므로 자동 회원가입을 진행합니다.");
